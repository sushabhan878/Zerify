...
export default function FaqSection() {
  ...
  return (
    <section id="faq" className="py-28 relative overflow-hidden bg-[#07090E]">
      {/* Background Glow Effects */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[450px] bg-purple-600/10 rounded-full blur-[170px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-purple-950/40 via-slate-900 to-indigo-950/40 border border-white/15 backdrop-blur-2xl flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Our partnership team is ready to answer all your onboarding queries.</p>
            </div>
          </div>
          <a
            href="#waitlist"
            className="px-6 py-2.5 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:opacity-95 text-white text-xs font-extrabold shadow-lg shadow-purple-500/30 transition-all flex items-center gap-2 group whitespace-nowrap"
          >
            <span>Ask Zerify Support</span>
