      ...
      {showCompletion && (
        <div className="pt-2 border-t border-white/10 space-y-2">
          ...
          <div className="w-full h-1.5 rounded-full bg-slate-950 overflow-hidden p-[1px] border border-white/5">
            <div
              className="h-full rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 transition-all duration-500 shadow-sm"
          ...
          <button
            onClick={onCompleteProfile}
            type="button"
            className="w-full py-1.5 px-2.5 rounded-xl bg-gradient-to-r from-purple-600/20 to-pink-600/20 hover:from-purple-600/35 hover:to-pink-600/35 border border-purple-500/40 text-white font-extrabold text-[10.5px] flex items-center justify-center gap-1.5 transition-all group shadow-sm"
          >
