export const ALL_INDUSTRIES_GROUPED = [
    {
        id: 'tech-ai',
...
export const ALL_INDUSTRIES_FLAT = ALL_INDUSTRIES_GROUPED.flatMap((group) => group.items);
export const PRIMARY_CATEGORY_NAMES = ALL_INDUSTRIES_GROUPED.map((group) => group.category);
export const SUGGESTED_OBJECTIVE_TAGS = [
    'Brand Awareness',
    'Product Launch',
    'Website Traffic',
    'App Installs',
